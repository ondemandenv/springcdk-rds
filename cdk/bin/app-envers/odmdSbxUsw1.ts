...
export class EnverConfigImpl implements AppEnverConfig {
    appUsr: PgUsr = {
        roleType: "app",
        userName: ('appUsr' + OndemandContracts.REV_REF_value.substring(3) + '_19').toLowerCase()
    };
    migUsr: PgUsr = {
        roleType: "migrate",
        userName: ('migUsr' + OndemandContracts.REV_REF_value.substring(3) + '_19').toLowerCase()
    };
